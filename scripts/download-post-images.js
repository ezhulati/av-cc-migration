#!/usr/bin/env node
/**
 * Download post images from CSV export
 */
...
const CSV_FILE = path.join(projectRoot, 'Posts-Export-2025-October-17-0417.csv');
const OUTPUT_DIR = path.join(projectRoot, 'public', 'images', 'posts');
...
async function processCSV() {
  ...
  console.log('🖼️  Post Image Downloader');
  console.log('='.repeat(80));
  console.log(`Processing ${lines.length - 1} posts...\n`);
