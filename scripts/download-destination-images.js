#!/usr/bin/env node
/**
 * Download destination images from CSV export
 */
...
const CSV_FILE = path.join(projectRoot, 'Destinations-Export-2025-October-17-0420.csv');
const OUTPUT_DIR = path.join(projectRoot, 'public', 'images', 'destinations');
...
async function processCSV() {
  ...
  console.log('🏞️  Destination Image Downloader');
  console.log('='.repeat(80));
  console.log(`Processing ${lines.length - 1} destinations...\n`);
