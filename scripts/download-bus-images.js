#!/usr/bin/env node
/**
 * Download bus route images from CSV export
 */
...
const CSV_FILE = path.join(projectRoot, 'Bus-Export-2025-October-17-0441.csv');
const OUTPUT_DIR = path.join(projectRoot, 'public', 'images', 'buses');
...
async function processCSV() {
  ...
  console.log('🚌 Bus Route Image Downloader');
  console.log('='.repeat(80));
  console.log(`Processing ${lines.length - 1} bus routes...\n`);
