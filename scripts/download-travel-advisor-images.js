#!/usr/bin/env node
/**
 * Download travel advisor images from CSV export
 */
...
const CSV_FILE = path.join(projectRoot, 'Travel-Advisor-Export-2025-October-17-0427.csv');
const OUTPUT_DIR = path.join(projectRoot, 'public', 'images', 'pages');
...
async function processCSV() {
  ...
  console.log('🧭 Travel Advisor Image Downloader');
  console.log('='.repeat(80));
  console.log(`Processing ${lines.length - 1} pages...\n`);
